...
module.exports = {
  encode: __webpack_require__(28),
  decode: __webpack_require__(29),
  encodingLength: __webpack_require__(30)
};
...
const multicodec = __webpack_require__(32);

const codecs = __webpack_require__(3);

const CIDUtil = __webpack_require__(37);

const withIs = __webpack_require__(38);
/**
...
const protons = __webpack_require__(41);

const pb = protons(__webpack_require__(52));
...
function _emitBytes() {
  _emitBytes = _wrapAsyncGenerator(function* (ipld, node, start, end, streamPosition = 0, options) {
    // a `raw` node
    ...
    for (let i = 0; i < node.Links.length; i++) {
      ...
      start < childStart && end > childEnd) {
        ...
        const child = yield _awaitAsyncGenerator(ipld.get(childLink.Hash, options));
        ...
        try {
          for (var _iterator = _asyncIterator(emitBytes(ipld, child, start, end, streamPosition, options)), _step, _value; _step = yield _awaitAsyncGenerator(_iterator.next()), _iteratorNormalCompletion = _step.done, _value = yield _awaitAsyncGenerator(_step.value), !_iteratorNormalCompletion; _iteratorNormalCompletion = true) {
            const buf = _value;
            streamPosition += buf.length;
            yield buf;
          }
...
const resolve = __webpack_require__(39);

const last = __webpack_require__(75);
...
const walkPath = /*#__PURE__*/function () {
  var _ref = _wrapAsyncGenerator(function* (path, ipld, options) {
    let {
      cid,
      toResolve
    } = cidAndRest(path);
    ...
    while (true) {
      const result = yield _awaitAsyncGenerator(resolve(cid, name, entryPath, toResolve, startingDepth, ipld, options));
...
const recursive = /*#__PURE__*/function () {
  var _ref2 = _wrapAsyncGenerator(function* (path, ipld, options) {
    const node = yield _awaitAsyncGenerator(exporter(path, ipld, options));
    yield node;
        ...
        try {
          for (var _iterator2 = _asyncIterator(node.content(options)), _step2, _value2; _step2 = yield _awaitAsyncGenerator(_iterator2.next()), _iteratorNormalCompletion2 = _step2.done, _value2 = yield _awaitAsyncGenerator(_step2.value), !_iteratorNormalCompletion2; _iteratorNormalCompletion2 = true) {
            ...
            if (file.unixfs.type.includes('dir')) {
              ...
              try {
                for (var _iterator3 = _asyncIterator(recurse(file, options)), _step3, _value3; _step3 = yield _awaitAsyncGenerator(_iterator3.next()), _iteratorNormalCompletion3 = _step3.done, _value3 = yield _awaitAsyncGenerator(_step3.value), !_iteratorNormalCompletion3; _iteratorNormalCompletion3 = true) {
...
const baseX = __webpack_require__(24);

const base16 = __webpack_require__(25);

const base32 = __webpack_require__(26);

const base64 = __webpack_require__(27); // name, code, implementation, alphabet
...
const intTable = __webpack_require__(33);
...
exports.print = __webpack_require__(36);
...
const resolvers = {
  'dag-pb': __webpack_require__(40),
  raw: __webpack_require__(72),
  'dag-cbor': __webpack_require__(73),
...
const findShardCid = __webpack_require__(53);
...
const contentExporters = {
  ...
  'hamt-sharded-directory': __webpack_require__(71),
...
var compileDecode = __webpack_require__(49);

var compileEncode = __webpack_require__(50);

var compileEncodingLength = __webpack_require__(51);
...
var svarint = __webpack_require__(48);
...
const Bucket = __webpack_require__(54);
...
const SparseArray = __webpack_require__(55);

const wrapHash = __webpack_require__(56);
...
const ConsumableBuffer = __webpack_require__(57);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(60), __webpack_require__(8)))
  ...
  return /*#__PURE__*/function () {
    var _ref = _wrapAsyncGenerator(function* (options = {}) {
      ...
      for (const link of links) {
        const result = yield _awaitAsyncGenerator(resolve(link.Hash, link.Name, "".concat(path, "/").concat(link.Name), [], depth + 1, ipld, options));
        yield result.entry;
      }
    });
